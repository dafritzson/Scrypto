...
class Client(object):
    ...
    def order_limit_buy(self, timeInForce=TIME_IN_FORCE_IOC, **params):
    ...
    def order_limit_sell(self, timeInForce=TIME_IN_FORCE_IOC, **params):
    ...
    def create_test_order(self, **params):
        ...
        """
        params.update({'recvWindow':6000000})
